  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button v-if="scope.row.processState == 1"
            size="mini"
            type="text"
            icon="el-icon-edit"
          ...
          <el-button v-else
            ...
            type="text"
            icon="el-icon-edit"
            @click="handelUnDeploy(scope.row)"
            v-hasPermi="['system:post:edit']"
          >卸载</el-button>
          <el-button
            size="mini"
...
export default {
  ...
  methods: {
    ...
    handelDeploy(row) {
      ...
      this.$modal.confirm('是否确认部署流程编号为"' + postIds + '"的数据项？').then(function() {
        return deploy(postIds);
      }).then(() => {
        this.getList();
