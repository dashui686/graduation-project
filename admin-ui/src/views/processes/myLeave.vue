  ...
  <div class="continer">
    ...
    <el-form ref="leaveForm" :model="leaveFormData" :rules="isApprove?rules1:rules" size="medium" label-width="100px">
      ...
      <el-form-item label="审批人" prop="assignee">
        <el-select v-model="leaveFormData.assignee" :disabled="this.view" placeholder="请选择审批人" clearable :style="{width: '100%'}">
      ...
      <el-form-item label="审批理由" prop="approveReason" v-if="this.isApprove">
        <el-input v-model="leaveFormData.approveReason" :disabled="this.view" type="textarea" placeholder="请输入审批理由"
          :autosize="{minRows: 4, maxRows: 4}" :style="{width: '100%'}"></el-input>
      </el-form-item>
